...
//2nd function to find top Answerers. 

var Answerer = function(answer) {
	
	// Template code
	var result = $('.templates .answerers').clone();
	// Display Image
	var userImage = result.find('.image');
	...
	//Post Count 
	var userPostCount = result.find('.postcount');
